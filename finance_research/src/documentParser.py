...
class DocumentParser:
    ...
    def parse_documents(self):
        headers = ['company_name', 'filing_date', 'revenues', 'expenses', 'net_income', 'file_name']
    ...
    def parse_content(self, content):
        ...
        if company_name and filing_date and revenues and expenses and net_income:
            return {
...
file_path = '/Users/jorgevelez/Desktop/GitHub/reinforcement-learning-finance-research/finance_research/data/Washington-Mutual-data/0001104659-07-015590.txt'

# Define the directory where the file is located
document_dir = os.path.dirname(file_path)

# Define the output file path
output_file_path = '/Users/jorgevelez/Desktop/GitHub/reinforcement-learning-finance-research/finance_research/data/output.csv'

# Create an instance of the DocumentParser class
parser = DocumentParser(document_dir, output_file_path)

# Parse the documents in the directory
